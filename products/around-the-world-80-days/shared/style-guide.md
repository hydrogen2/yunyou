...
**Rhythm:** ≤ 90 s of continuous video before an interaction, map beat, or question. Never three video scenes in a row.
**Facts:** every claim cites F-ids. Numbers rounded and humanised ("about the length of three football pitches").
**Overlays:** ≤ 1 per 15 s. Captions ≤ 12 words. Pins carry a name + ≤ 6-word tag.
**Quiz:** 1 correct of 3–4; feedback for every option teaches something; never trick questions.
**Dialogue personas:** speak only within documented biography; when asked beyond it, say so in character.
