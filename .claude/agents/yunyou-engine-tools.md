...
description: Yunyou studio role — Engine / Tools (engineer). Reads studio/roles/engine-tools.md and studio/roles/_common.md, then builds/updates the tooling or prototype it is briefed on.
