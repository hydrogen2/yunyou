...
description: Yunyou studio role — Fact-Checker. Reads studio/roles/fact-checker.md and studio/roles/_common.md, then produces the document or artefact that role owns.
