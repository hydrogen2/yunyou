...
description: Yunyou studio role — Scene Developer. Reads studio/roles/scene-developer.md and studio/roles/_common.md, then produces the document or artefact that role owns.
