...
description: Yunyou studio role — Narrator / Voice. Reads studio/roles/narrator.md and studio/roles/_common.md, then produces the document or artefact that role owns.
